...
var define_FIXTURE_DIGESTS_default = {
  "src/components/alert/AlertComponent.tsx":
    "726d210fe0fb101e1319c7bee6fcd04b561539c170fd772d1aed7f090d56c957",
  "src/components/alert/alert.schema.json":
...
test("per-component styling hooks are exposed as a token partial", () => {
  expect(existsSync2(`${harness.dir}/_alert-tokens.scss`)).toBe(true);
});
