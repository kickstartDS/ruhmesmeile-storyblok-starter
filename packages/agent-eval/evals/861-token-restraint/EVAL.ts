...
var define_FIXTURE_DIGESTS_default = {
  "src/components/quote/QuoteComponent.tsx":
    "c8214013afbfaec565af052c8c7d7abb974e355f0fd936c9b1d6a82631eccc6a",
  "src/components/quote/_quote-tokens.scss":
    "efb18b1082dd961c29fae8b863f89406fb1817dc8ffe61649f405e4531c56375",
  "src/components/quote/quote.schema.json":
    "f2f7357cff71c5f4d9eaec9229906dc171ff5a4fecf6e4df7b2aed3547199ebd",
  "src/components/quote/quote.scss":
    "3780fc01761e3ad7dde6669af9194b1f1ef8834e49bbf8d3e7990b8a85daa77a",
...
// lib/eval-harness/sources/861-token-restraint.ts
import {
...
function summarise(raw) {
  ...
  for (const line of raw.split("\n")) {
    ...
    for (const block2 of Array.isArray(message?.content)
      ? message.content
      : []) {
      if (block2?.type === "tool_use" && typeof block2.name === "string") {
        toolCalls[block2.name] = (toolCalls[block2.name] ?? 0) + 1;
      }
    }
  }
...
var PARTIAL = `${harness.dir}/_quote-tokens.scss`;
var block = (styles, selector) => {
