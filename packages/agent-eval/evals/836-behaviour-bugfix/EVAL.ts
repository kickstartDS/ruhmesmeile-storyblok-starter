...
var define_FIXTURE_DIGESTS_default = {
  "src/components/dismissible/Dismissible.client.js":
    "bfd60fac04665f57318e3e13337f8d86c8a4fd017a79f8135fe7cbd8e382ebae",
  "src/components/dismissible/DismissibleComponent.tsx":
    "9db5cecdea510abb9a87b26f7380c53aeb62045bb2a3bf903a7d31638f302e15",
  "src/components/dismissible/dismissible.schema.json":
    "62ada109882a9e044247d2142cfffe683689b748d5892090214095feef9f0638",
  "src/components/dismissible/dismissible.scss":
    "3f135e862deebe58fe76518d210e05a0685c29753bd4251a2f09242b116239a0",
...
// lib/eval-harness/sources/836-behaviour-bugfix.ts
import {
...
async function mount() {
  ...
  const element = dom.window.document.querySelector(".dsa-dismissible");
  const button = dom.window.document.querySelector(".dsa-dismissible__close");
  let count = 0;
