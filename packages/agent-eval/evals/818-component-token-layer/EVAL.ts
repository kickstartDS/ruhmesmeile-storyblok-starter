...
var define_FIXTURE_DIGESTS_default = {
  "src/components/callout/CalloutComponent.tsx":
    "10abbc90af411859f63e0acaf3e6c0a12a7f0196ce983282331471375c83dafa",
  "src/components/callout/callout.schema.json":
    "1a7277ad47c672a0ba19a7d07a7e27acbdeef215ddecfc3ae606f3cdf3d7bf57",
  "src/components/callout/callout.scss":
    "60d39d4dbdc96bf4a3f0c39d29bdd7528a53c2567d2536ff82f635d785b282e9",
...
// lib/eval-harness/sources/818-component-token-layer.ts
import {
...
var allStyles = () =>
  readdirSync2(harness.dir)
    ...
    .map((name) => read(join2(harness.dir, name)))
    .join("\n");
var definedComponentTokens = () => {
...
test("a separate token file is actually included", () => {
  const partials = readdirSync2(harness.dir).filter(
