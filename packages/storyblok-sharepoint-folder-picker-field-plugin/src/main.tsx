...
// This error replaces another error which message is harder to understand
// and impossible to avoid until the issue
// https://github.com/storyblok/field-plugin/issues/107 has been resolved.
throw new Error(
